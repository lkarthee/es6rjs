...
This is a file which contains `require.config` and acts as `data-main` to require.js

## app/styles/main.css

This is a file where your custom CSS can go. You can place any Sass you wish to have compiled into the `styles` directory and renaming `main.css` to `main.scss` will cause es6rjs /Web Starter Kit to treat the file as Sass instead.
...
A [bower.json](https://bower.io/docs/creating-packages/#bowerjson) similar to Node's `package.json`. Refer to documentation to know more about [bower](https://bower.io/).
